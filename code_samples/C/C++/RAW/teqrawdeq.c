/* 
teqrawdeq.c 
Description - Dequeue RAW message from the Transactional Event Queue
...
int main(int argc, char *argv[])
{
  ...
  printf("Dequeue Done.\n");
  ub4 len = OCIRawSize(envhp, mesgp);
  unsigned char *data = OCIRawPtr(envhp, mesgp);
  // Convert to null-terminated string (if you know it's text-based)
