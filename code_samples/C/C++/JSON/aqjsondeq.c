/* 
aqjsondeq.c 
Description - Dequeue JSON message from the Advanced Queue
...
int main(int argc, char *argv[])
{
  ...
  checkerr(errhp, OCIAQDeq(svchp, errhp, (text *) queuename, NULL, NULL, mesg_tdo, (void **)&mesgp, (void **)&nmesgp, (OCIRaw **)&msgid, OCI_DEFAULT));
  printf("Dequeue Done.\n");
  oraub8      outlen = 1024;
